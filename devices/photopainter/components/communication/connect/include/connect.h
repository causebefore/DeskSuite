 ...
 */
    typedef esp_err_t (*connect_credentials_cb_t)(const connect_portal_submission_t *submission,
                                                  void                              *ctx);
 ...
 */
    typedef esp_err_t (*connect_qr_fill_dark_rect_cb_t)(uint16_t x_pixels, uint16_t y_pixels,
 ...
 */
    esp_err_t connect_render_portal_qr_borrow(const connect_portal_info_t *in_portal,
                                              uint16_t                     max_side_pixels,
