...
extern "C"
{
    ...
    typedef enum
    {
        APP_WEB_FILE_STATE_STOPPED = 0,       /**< 未持有运行期 Service 或网络租约 */
        APP_WEB_FILE_STATE_CHECKING_STORAGE,  /**< 正在确认 SD 文件系统与容量 */
        APP_WEB_FILE_STATE_ACQUIRING_NETWORK, /**< 正在申请 Web 文件网络租约 */
        APP_WEB_FILE_STATE_STARTING_SERVICE,  /**< 正在初始化并启动网页文件 Service */
        APP_WEB_FILE_STATE_RUNNING,           /**< 网页文件 Service 正在运行 */
        APP_WEB_FILE_STATE_STOPPING,          /**< 正在安全停止 Service 并释放网络租约 */
     ...
     * Composition Root 必须先初始化 `web_file_service` 和 `app_network`。已处于无保留资源的
