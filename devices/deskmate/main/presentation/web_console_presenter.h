/**
 * @file web_console_presenter.h
 * @brief 网页控制台设备端纯展示事实与 View Model 接口
 */
#pragma once
...
extern "C"
{
    ...
    /** @brief 网页控制台 Presenter 的稳定展示状态 */
    typedef enum
    {
        WEB_CONSOLE_PRESENTER_STATE_STOPPED = 0,       /**< 未启用网页控制台 */
        WEB_CONSOLE_PRESENTER_STATE_CHECKING_STORAGE,  /**< 正在检查 SD 文件系统 */
        WEB_CONSOLE_PRESENTER_STATE_ACQUIRING_NETWORK, /**< 正在申请网络租约 */
        WEB_CONSOLE_PRESENTER_STATE_STARTING_SERVICE,  /**< 正在启动网页控制台 Service */
        WEB_CONSOLE_PRESENTER_STATE_RUNNING,           /**< 网页控制台正在运行 */
        WEB_CONSOLE_PRESENTER_STATE_STOPPING,          /**< 正在安全关闭网页控制台 */
        WEB_CONSOLE_PRESENTER_STATE_ERROR,             /**< 启动或关闭失败 */
    } web_console_presenter_state_t;

    /** @brief Application 按值推送给 Presenter 的有界纯展示事实 */
    typedef struct
    {
        uint64_t                      presentation_revision; /**< Application 分配的严格单调展示版本 */
        web_console_presenter_state_t state;                 /**< 当前展示状态 */
    ...
    } web_console_presenter_input_t;

    /** @brief 网页控制台页面按值读取的有界 View Model */
    typedef struct
    {
        web_console_presenter_state_t state;          /**< 当前展示状态 */
        ...
        esp_err_t                     error;          /**< 最近一次启动或停止错误 */
    } web_console_view_model_t;

    /**
     * @brief 初始化网页控制台 Presenter
     *
