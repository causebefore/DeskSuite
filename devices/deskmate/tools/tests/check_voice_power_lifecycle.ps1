...
Assert-Contains $voiceHeader 'voice_service_request_conversation_copy\s*\('
Assert-Contains $voiceHeader 'bool\s+conversation_task_active'
Assert-NotContains $voiceHeader 'voice_service_request_chat\s*\('
Assert-NotContains $voiceHeader 'chat_task_active'
Assert-Contains $voiceSource 'runtime->state\s*=\s*VOICE_SERVICE_STATE_STOPPED'
Assert-Contains $voiceTask 'void\s+voice_conversation_task'
Assert-Contains $voiceSource 'voice_service_run_conversation\s*\('
Assert-Contains $voiceSource 'CONFIG_DESKMATE_VOICE_VAD_LEAD_TIMEOUT_MS'
Assert-Contains $voiceSource 'runtime->followup_timeout_ms'
...
Assert-Contains $appVoiceSource 'voice_service_request_conversation_copy'
Assert-Contains $appVoiceSource 'CONFIG_DESKMATE_VOICE_FOLLOWUP_TIMEOUT_MS'
...
Assert-Contains $powerTask 'voice\.conversation_task_active'
