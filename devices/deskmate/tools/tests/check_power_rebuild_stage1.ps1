...
Assert-Contains $bspHeader 'bool\s+rtc_timer'
Assert-Contains $deviceHeader 'device_power_enter_light_sleep'
Assert-Contains $deviceHeader 'bool\s+timer'
Assert-Contains $deviceHeader 'bool\s+rtc_timer'
Assert-Contains $deviceSource 'bsp_power_enter_light_sleep'
Assert-Contains $bspSource 'bsp_rtc_clear_interrupt_sources'
Assert-Contains $bspSource 'bsp_rtc_start_wakeup_timer'
Assert-Contains $bspSource 'bsp_rtc_stop_wakeup_timer'
...
Assert-Contains $powerTask 'APP_POWER_WAKEUP_RTC_TIMER'
Assert-Contains $powerTask 'APP_POWER_WAKEUP_TIMER'
Assert-Contains $powerTask 'rtc_timer_refresh_count'
...
Assert-Contains 'main\Kconfig.projbuild' 'DESKMATE_RTC_INT_WAKE_TEST_ENABLED[\s\S]{0,160}default n'
